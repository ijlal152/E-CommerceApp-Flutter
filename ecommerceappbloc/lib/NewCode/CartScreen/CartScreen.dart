...
class _CartScreenState extends State<CartScreen> {
  ...
  late List<double> doubleSum; // converted list [from dynamic to double]
  double sum = 0;
              ...
              actions: [
                Padding(
                  ...
                  child: Container(
                    ...
                    child: Text('Pay $sum', style: const TextStyle(
                      color: Colors.white,
                ...
                Padding(
                  ...
                  child: ListView.separated(
                      ...
                      itemBuilder: (_, index) {
                        ...
                        sumList.add(sofaList[index].totalPrice);
                        //print(sumList);
                                              ...
                                              children: [
                                                ...
                                                InkWell(
                                                    onTap: () {
                                                      setState(() {
                                                        sofaList[index].qty ++;
                                                        //sumList.add(totalPrice);
                                                      });
                                                      // context.read<CounterBloc>().add(
                                                      //     CounterIncrementEvent());
                                                      //increment(sofaList[index].qty);
                                                    },
                                                    child: const Icon(
