import 'package:ecommerceappbloc/model/category.dart';
import 'package:ecommerceappbloc/presentation/mostpopular/most_popular_screen.dart';
import 'package:ecommerceappbloc/presentation/widgets/special_offer_widget.dart';
        ...
        GridView.builder(
          ...
          itemBuilder: ((context, index) {
            ...
            return GestureDetector(
              onTap: () => Navigator.push(context, MaterialPageRoute(builder: (context) => MostPopularScreen())),
              child: Column(
                children: [
                  Container(
